...
//     EventFactory.ContractInfo memory x = fact.getAllEvents()[0];
//     address a;
//         EventFactory.ContractInfo memory y = EventFactory.ContractInfo(a,3000);
//     // address zero;
//     // (address x,uint t )= fact.allContracts(0);
//     require(keccak256(x) == keccak256(y),"");
